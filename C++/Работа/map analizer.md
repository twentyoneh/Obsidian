...
2. 0x везде х нижнего регистра;
3. нет размерности и пересчета размеров по единицам;
4. модель МК нет;
5. неправильные названия областей и их адреса;
6. общий объем, свободно, занято по банкам нет;
7. последний адрес в банках без размера самих данных;
8. расположение адресов по краям и в центре;
9. при поиске не указывает тип банки, нет адреса конца, нет размерности.
10. фильтр по разрешению map;
